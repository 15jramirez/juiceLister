...
#   Character.create(name: 'Luke', movie: movies.first)
 ...
 two = Juice.create!({name: "jugo de betabel- Beet Juice", ingredients:{carrot: "5 sticks. can be sliced", beets: "4 large pieces or 6 small", orange: "125ml(4 cups) of fresh squeezed orange or orange juice"}, category_id:2})
 two.save
